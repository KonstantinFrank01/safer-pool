...
image::http://www.plantuml.com/plantuml/proxy?chache=n0&src=https://raw.githubusercontent.com/KonstantinFrank01/safer-pool/KonstantinFrank01-patch-1/Assets/use-case-diagram.iuml[]
